...
xhost local:root
docker run -it --net host --gpus all -v /tmp/.X11-unix:/tmp/.X11-unix -e DISPLAY=unix$DISPLAY -v /var/run/dbus/system_bus_socket:/var/run/dbus/system_bus_socket -v /data/chrome/Downloads:/home/chrome/Downloads -v /data/chrome/data:/data --device /dev/snd --device /dev/dri -v /dev/shm:/dev/shm --security-opt seccomp=/data/chrome/chrome.json --name "chrome-ubuntu" "chrome-ubuntu" --no-sandbox
